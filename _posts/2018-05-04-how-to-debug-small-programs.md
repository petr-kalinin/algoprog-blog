...
> и его [русский перевод](https://habrahabr.ru/post/339038/), но на мой взгляд
...
При этом надо где-то глубоко в уме все-таки помнить, какую задачу вы решаете, и какой код зачем написан,
...
возникла потому, что вы видите, что в коде написано `range(len(a))`, значит, надо объяснить уточке,
